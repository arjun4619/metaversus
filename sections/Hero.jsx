...
const Hero = () => (
  <section className={`${styles.yPaddings} sm:pl-16 pl-6`}>
    <motion.div variants={staggerContainer} className={`${styles.innerWidth} mx-auto flex flex-col`} initial="hidden" whileInView="show" viewport={{ once: false, amount: 0.25 }}>
